      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <motion.div
              ...
              className="mb-4"
            >
              <h3 className="text-xl font-mono font-bold bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">
                {'<DigitalTeam />'}
              </h3>
            </motion.div>
            <motion.p
        ...
        >
          ...
          <motion.div
            ...
            className="flex items-center space-x-1 text-gray-400 text-sm mt-4 md:mt-0"
          >
            <span>Made with</span>
